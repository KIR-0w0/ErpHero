							...
							<div class="row mb-3">
								<div class="col">
									...
									<div style="padding:10px;">
										사업장 <input type="text" name="empWorkPlaceCode" id="emp-workPlace-code" value="">
										부서 <input type="text" name="deptCode" id="dept-code" value="">
										사원 <input type="text" name="empCode" id="emp-code" value="EP210001">
										계획기간 <input type="date" id="planning-start-date" name="startDate"> ~ 
												<input type="date" id="planning-end-date" name="endDate">
										<button type="button" class="btn btn-primary btn-sm" id="btn-get-allPlannings">조회</button>
										<button type="button" class="btn btn-primary btn-sm" id="btn-post-plannings" disabled>저장</button>
...
$(function (){
		...
		$.ajax({
			...
			success: function (contracts){
				...
				$.each(contracts, function(index, contract) {
						...
						var $td0 = $("<td><input type='checkbox' name='contract' value='"+index+"'/></td>")
						...
						var $td9 = $("<td></td>").text(contract.cpDeliveryDate);
						var $td10 = $("<td></td>").text(contract.contractProductNo); //보이지 않기		
	...
	$('#btn-post-plannings').click(function () { 
		...
		/*console.log(planning.contractProductNo);
		console.log(contractCode);
		if (planning.contractProductNo == contractCode) {
			alert("해당상품에 대한 주계획이 이미 존재합니다.");
			return false;
		}*/
		...
		$(":checkbox[name=contractToPlanning]:checked").each(function (index, checkbox) {
			...
			var planning = {
					...
					empCode: "EP210001", //${Logined_EMP.code},
