					...
					<div class="row mb-3">
						<div class="col">
							<div style="padding:10px;">
								...
								요청일자 <input type="date" id="planning-start-date" name="startDate"> ~ 
	...
	$('#btn-select-charge').click(function() {
		...
		(function () {
			...
			var topRow = "<tr>"
				...
				topRow += "<td class='text-center'><input type='text' name='userid-"+groupNo+"' value='로그인된 사람'></td>"
				topRow += "</tr>";
	...
	$('#btn-post-charges').click(function () { 
		...
		$("#table-charge :checkbox:checked").each(function (index, checkbox) {
			...
			var charge = {
					...
					writerName: $topTr.find(":input[name=userid-"+groupNo+"]").val(),
					chargeProducts: []
			}
			//1:1
			//1:n
